  ...
  <section class="portfolio-hero portfolio-hero--compact fade-in">
    <div class="portfolio-hero__card">
      ...
      <div class="portfolio-hero__visual">
        <div class="accent-shape accent-shape--projects"></div>
      </div>
    </div>
  </section>
    ...
    {% for project in site.projects %}
      <article class="archive__item project-card" 
        ...
        <div class="project-content">
          ...
          {% assign has_valid_links = false %}
          {% if project.links %}
            {% for link in project.links %}
              {% if link.url and link.url != '#' %}
                {% assign has_valid_links = true %}
              {% endif %}
            {% endfor %}
          {% endif %}
...
[
  {% for project in site.projects %}
  {
    ...
    "image": {% if project.image %}{{ project.image | relative_url | jsonify }}{% else %}null{% endif %},
    "content": {{ project.content | markdownify | jsonify }},
